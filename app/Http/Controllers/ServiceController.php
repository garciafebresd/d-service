...
class ServiceController extends AppBaseController {
    ...
    public function __construct(ServiceRepository $serviceRepo,ServiceTypeRepository $serviceTypeRepo) {
    ...
    public function edit($id) {
        ...
        $serviceTypes = $this->serviceTypeRepository->all();
        return view('services.edit')->with(array('service'=>$service,'serviceTypes'=>$serviceTypes));
    }
